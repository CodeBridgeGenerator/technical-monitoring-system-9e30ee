...
import seederData from "./checks.seeder.json";
...
const ChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChecksSeederDialogComponent);
