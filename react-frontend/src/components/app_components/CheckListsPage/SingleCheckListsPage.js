...
const SingleCheckListsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("checkLists")
            .get(urlParams.singleCheckListsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCheckListsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">CheckLists</h3>
                    <SplitButton
                ...
                {/* <p>checkLists/{urlParams.singleCheckListsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3" >{_entity?.description}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleCheckListsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleCheckListsPage);
