...
import seederData from "./checkLists.seeder.json";
...
const CheckListsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CheckListsSeederDialogComponent);
