...
import seederData from "./breakDownTickets.seeder.json";
...
const BreakDownTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BreakDownTicketsSeederDialogComponent);
