...
import seederData from "./checkListForms.seeder.json";
...
const CheckListFormsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CheckListFormsSeederDialogComponent);
