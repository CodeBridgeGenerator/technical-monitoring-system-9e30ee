...
import seederData from "./timerServices.seeder.json";
...
const TimerServicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TimerServicesSeederDialogComponent);
