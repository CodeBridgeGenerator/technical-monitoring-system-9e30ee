...
import SingleChecksPage from "../components/app_components/ChecksPage/SingleChecksPage";
import CheckProjectLayoutPage from "../components/app_components/ChecksPage/CheckProjectLayoutPage";
import SingleCheckListsPage from "../components/app_components/CheckListsPage/SingleCheckListsPage";
import CheckListProjectLayoutPage from "../components/app_components/CheckListsPage/CheckListProjectLayoutPage";
import SingleCheckListFormsPage from "../components/app_components/CheckListFormsPage/SingleCheckListFormsPage";
import CheckListFormProjectLayoutPage from "../components/app_components/CheckListFormsPage/CheckListFormProjectLayoutPage";
import SingleTimerServicesPage from "../components/app_components/TimerServicesPage/SingleTimerServicesPage";
import TimerServiceProjectLayoutPage from "../components/app_components/TimerServicesPage/TimerServiceProjectLayoutPage";
import SingleBreakDownTicketsPage from "../components/app_components/BreakDownTicketsPage/SingleBreakDownTicketsPage";
import BreakDownTicketProjectLayoutPage from "../components/app_components/BreakDownTicketsPage/BreakDownTicketProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/checks/:singleChecksId" exact element={<SingleChecksPage />} />
<Route path="/checks" exact element={<CheckProjectLayoutPage />} />
<Route path="/checkLists/:singleCheckListsId" exact element={<SingleCheckListsPage />} />
<Route path="/checkLists" exact element={<CheckListProjectLayoutPage />} />
<Route path="/checkListForms/:singleCheckListFormsId" exact element={<SingleCheckListFormsPage />} />
<Route path="/checkListForms" exact element={<CheckListFormProjectLayoutPage />} />
<Route path="/timerServices/:singleTimerServicesId" exact element={<SingleTimerServicesPage />} />
<Route path="/timerServices" exact element={<TimerServiceProjectLayoutPage />} />
<Route path="/breakDownTickets/:singleBreakDownTicketsId" exact element={<SingleBreakDownTicketsPage />} />
<Route path="/breakDownTickets" exact element={<BreakDownTicketProjectLayoutPage />} />
