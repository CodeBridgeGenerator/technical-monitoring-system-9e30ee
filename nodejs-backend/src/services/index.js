...
const checkLists = require("./checkLists/checkLists.service.js");
const checkListForms = require("./checkListForms/checkListForms.service.js");
const timerServices = require("./timerServices/timerServices.service.js");
const breakDownTickets = require("./breakDownTickets/breakDownTickets.service.js");
...
module.exports = function (app) {
  ...
  app.configure(checkLists);
  app.configure(checkListForms);
  app.configure(timerServices);
  app.configure(breakDownTickets);
